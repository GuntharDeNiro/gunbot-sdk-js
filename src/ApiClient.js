...
export default class ApiClient {
    ...
    */
    callApi(path, httpMethod, pathParams,
        ...
        // ──────────────────────────────────────────────────────────────
        // If the caller passed a node-style callback we keep
        // the original behaviour (callback → call .end() immediately)
        // Otherwise we return a bare SuperAgent request and let the
        // consumer use the built-in promise interface (await / .then()).
        // ──────────────────────────────────────────────────────────────
