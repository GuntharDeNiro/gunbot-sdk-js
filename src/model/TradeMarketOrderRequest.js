...
import TradeMarketOrderData from './TradeMarketOrderData.js';
...
export default class TradeMarketOrderRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeMarketOrderRequest();
...
/**
 * @member {module:model/TradeMarketOrderData} data
 */
TradeMarketOrderRequest.prototype.data = undefined;
