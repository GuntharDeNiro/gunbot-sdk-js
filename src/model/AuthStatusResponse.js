...
export default class AuthStatusResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AuthStatusResponse();
 ...
 * @member {Number} code
 */
AuthStatusResponse.prototype.code = undefined;

/**
 * @member {Boolean} isDemo
 */
AuthStatusResponse.prototype.isDemo = undefined;

/**
 * @member {Boolean} isRegistered
 */
AuthStatusResponse.prototype.isRegistered = undefined;

/**
 * @member {Boolean} isTwoFA
 */
AuthStatusResponse.prototype.isTwoFA = undefined;

/**
 * @member {Boolean} metamask
 */
AuthStatusResponse.prototype.metamask = undefined;

/**
 * @member {String} status
 */
AuthStatusResponse.prototype.status = undefined;

/**
 * @member {String} message
 */
AuthStatusResponse.prototype.message = undefined;
