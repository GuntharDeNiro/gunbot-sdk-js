...
import TradeStopLimitData from './TradeStopLimitData.js';
...
export default class TradeStopLimitRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeStopLimitRequest();
...
/**
 * @member {module:model/TradeStopLimitData} data
 */
TradeStopLimitRequest.prototype.data = undefined;
