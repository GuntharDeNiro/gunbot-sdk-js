...
/**
 * The OneOfFileWriteRequestDocument model module.
 * @module model/OneOfFileWriteRequestDocument
 * @version v1
 */
export default class OneOfFileWriteRequestDocument {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OneOfFileWriteRequestDocument();
    }
    return obj;
  }
}
