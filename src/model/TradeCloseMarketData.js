...
export default class TradeCloseMarketData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeCloseMarketData();
 ...
 * @member {String} exch
 */
TradeCloseMarketData.prototype.exch = undefined;

/**
 * @member {String} pair
 */
TradeCloseMarketData.prototype.pair = undefined;

/**
 * @member {Number} amt
 */
TradeCloseMarketData.prototype.amt = undefined;
