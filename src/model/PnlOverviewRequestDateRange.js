...
export default class PnlOverviewRequestDateRange {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PnlOverviewRequestDateRange();
 ...
 */
PnlOverviewRequestDateRange.prototype.startDate = undefined;

/**
 * End timestamp in milliseconds.
 * @member {Number} endDate
 */
PnlOverviewRequestDateRange.prototype.endDate = undefined;
