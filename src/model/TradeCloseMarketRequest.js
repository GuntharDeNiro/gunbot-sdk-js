...
import TradeCloseMarketData from './TradeCloseMarketData.js';
...
export default class TradeCloseMarketRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeCloseMarketRequest();
...
/**
 * @member {module:model/TradeCloseMarketData} data
 */
TradeCloseMarketRequest.prototype.data = undefined;
