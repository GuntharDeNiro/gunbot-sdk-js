...
import TradeTrailingStopData from './TradeTrailingStopData.js';
...
export default class TradeTrailingStopRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeTrailingStopRequest();
...
/**
 * @member {module:model/TradeTrailingStopData} data
 */
TradeTrailingStopRequest.prototype.data = undefined;
