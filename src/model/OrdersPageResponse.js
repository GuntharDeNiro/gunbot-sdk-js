...
export default class OrdersPageResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OrdersPageResponse();
 ...
 * @member {Number} total
 */
OrdersPageResponse.prototype.total = undefined;

/**
 * @member {Number} page
 */
OrdersPageResponse.prototype.page = undefined;

/**
 * @member {Array.<Object.<String, Object>>} data
 */
OrdersPageResponse.prototype.data = undefined;
