...
export default class TradeLimitOrderData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeLimitOrderData();
 ...
 * @member {String} exch
 */
TradeLimitOrderData.prototype.exch = undefined;

/**
 * @member {String} pair
 */
TradeLimitOrderData.prototype.pair = undefined;

/**
 * @member {Number} amt
 */
TradeLimitOrderData.prototype.amt = undefined;

/**
 * @member {Number} price
 */
TradeLimitOrderData.prototype.price = undefined;
