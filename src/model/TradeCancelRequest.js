...
import TradeCancelData from './TradeCancelData.js';
...
export default class TradeCancelRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeCancelRequest();
...
/**
 * @member {module:model/TradeCancelData} data
 */
TradeCancelRequest.prototype.data = undefined;
