...
export default class ConfigPairAddRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ConfigPairAddRequest();
 ...
 * @member {String} pair
 */
ConfigPairAddRequest.prototype.pair = undefined;

/**
 * The exchange name (e.g., `binance`).
 * @member {String} exchange
 */
ConfigPairAddRequest.prototype.exchange = undefined;

/**
 * (Optional) Specific settings for the trading pair.
 * @member {Object.<String, Object>} settings
 */
ConfigPairAddRequest.prototype.settings = undefined;
