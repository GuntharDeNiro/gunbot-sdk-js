...
import TradeLimitOrderData from './TradeLimitOrderData.js';
...
export default class TradeLimitOrderRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeLimitOrderRequest();
...
/**
 * @member {module:model/TradeLimitOrderData} data
 */
TradeLimitOrderRequest.prototype.data = undefined;
