...
import ChartMarkItem from './ChartMarkItem.js';

/**
 * The ChartMarksResponse model module.
 * @module model/ChartMarksResponse
 * @version v1
 */
export default class ChartMarksResponse extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ChartMarksResponse();
