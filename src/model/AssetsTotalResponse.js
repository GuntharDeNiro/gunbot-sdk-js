...
import AssetTotalItem from './AssetTotalItem.js';

/**
 * The AssetsTotalResponse model module.
 * @module model/AssetsTotalResponse
 * @version v1
 */
export default class AssetsTotalResponse extends Array {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AssetsTotalResponse();
