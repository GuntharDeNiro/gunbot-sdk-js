...
import TradeCloseLimitData from './TradeCloseLimitData.js';
...
export default class TradeCloseLimitRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TradeCloseLimitRequest();
...
/**
 * @member {module:model/TradeCloseLimitData} data
 */
TradeCloseLimitRequest.prototype.data = undefined;
