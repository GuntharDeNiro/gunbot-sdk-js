...
export default class PnlSumResponseTournamentData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new PnlSumResponseTournamentData();
 ...
 */
PnlSumResponseTournamentData.prototype.sommaPnl = undefined;

/**
 * @member {String} invested
 */
PnlSumResponseTournamentData.prototype.invested = undefined;
