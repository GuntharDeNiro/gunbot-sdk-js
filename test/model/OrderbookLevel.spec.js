...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderbookLevel', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OrderbookLevel();
      });

      it('should create an instance of OrderbookLevel', function() {
        // TODO: update the code to test OrderbookLevel
        expect(instance).to.be.a(GunbotRestApi.OrderbookLevel);
      });
