...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoreMemSingleRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.CoreMemSingleRequest();
      });

      it('should create an instance of CoreMemSingleRequest', function() {
        // TODO: update the code to test CoreMemSingleRequest
        expect(instance).to.be.a(GunbotRestApi.CoreMemSingleRequest);
      });
