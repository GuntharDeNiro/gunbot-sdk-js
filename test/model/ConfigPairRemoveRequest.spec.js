...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigPairRemoveRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ConfigPairRemoveRequest();
      });

      it('should create an instance of ConfigPairRemoveRequest', function() {
        // TODO: update the code to test ConfigPairRemoveRequest
        expect(instance).to.be.a(GunbotRestApi.ConfigPairRemoveRequest);
      });
