...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GunbotConfig', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.GunbotConfig();
      });

      it('should create an instance of GunbotConfig', function() {
        // TODO: update the code to test GunbotConfig
        expect(instance).to.be.a(GunbotRestApi.GunbotConfig);
      });
