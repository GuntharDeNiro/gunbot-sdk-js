...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlSumResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlSumResponse();
      });

      it('should create an instance of PnlSumResponse', function() {
        // TODO: update the code to test PnlSumResponse
        expect(instance).to.be.a(GunbotRestApi.PnlSumResponse);
      });

      it('should have the property tournamentData (base name: "tournamentData")', function() {
        // TODO: update the code to test the property tournamentData
        expect(instance).to.have.property('tournamentData');
        // expect(instance.tournamentData).to.be(expectedValueLiteral);
      });
