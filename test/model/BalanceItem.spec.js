...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BalanceItem', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.BalanceItem();
      });

      it('should create an instance of BalanceItem', function() {
        // TODO: update the code to test BalanceItem
        expect(instance).to.be.a(GunbotRestApi.BalanceItem);
      });
      ...
      it('should have the property availableQty (base name: "Available Qty")', function() {
        // TODO: update the code to test the property availableQty
        expect(instance).to.have.property('availableQty');
        // expect(instance.availableQty).to.be(expectedValueLiteral);
      });

      it('should have the property onOrder (base name: "On Order")', function() {
        // TODO: update the code to test the property onOrder
        expect(instance).to.have.property('onOrder');
        // expect(instance.onOrder).to.be(expectedValueLiteral);
      });
