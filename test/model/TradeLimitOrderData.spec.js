...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeLimitOrderData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeLimitOrderData();
      });

      it('should create an instance of TradeLimitOrderData', function() {
        // TODO: update the code to test TradeLimitOrderData
        expect(instance).to.be.a(GunbotRestApi.TradeLimitOrderData);
      });
