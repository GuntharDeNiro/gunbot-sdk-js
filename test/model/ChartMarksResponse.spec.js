...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartMarksResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ChartMarksResponse();
      });

      it('should create an instance of ChartMarksResponse', function() {
        // TODO: update the code to test ChartMarksResponse
        expect(instance).to.be.a(GunbotRestApi.ChartMarksResponse);
      });
