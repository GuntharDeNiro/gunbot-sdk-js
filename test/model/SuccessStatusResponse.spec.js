...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SuccessStatusResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.SuccessStatusResponse();
      });

      it('should create an instance of SuccessStatusResponse', function() {
        // TODO: update the code to test SuccessStatusResponse
        expect(instance).to.be.a(GunbotRestApi.SuccessStatusResponse);
      });
