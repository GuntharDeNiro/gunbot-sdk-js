...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlOverviewRequestDateRange', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlOverviewRequestDateRange();
      });

      it('should create an instance of PnlOverviewRequestDateRange', function() {
        // TODO: update the code to test PnlOverviewRequestDateRange
        expect(instance).to.be.a(GunbotRestApi.PnlOverviewRequestDateRange);
      });
