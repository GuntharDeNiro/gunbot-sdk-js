...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PairDetailItem', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PairDetailItem();
      });

      it('should create an instance of PairDetailItem', function() {
        // TODO: update the code to test PairDetailItem
        expect(instance).to.be.a(GunbotRestApi.PairDetailItem);
      });

      it('should have the property pairName (base name: "pairName")', function() {
        // TODO: update the code to test the property pairName
        expect(instance).to.have.property('pairName');
        // expect(instance.pairName).to.be(expectedValueLiteral);
      });
