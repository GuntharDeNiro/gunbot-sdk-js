...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OneOfFileWriteRequestDocument', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OneOfFileWriteRequestDocument();
      });

      it('should create an instance of OneOfFileWriteRequestDocument', function() {
        // TODO: update the code to test OneOfFileWriteRequestDocument
        expect(instance).to.be.a(GunbotRestApi.OneOfFileWriteRequestDocument);
      });
