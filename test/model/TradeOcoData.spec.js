...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeOcoData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeOcoData();
      });

      it('should create an instance of TradeOcoData', function() {
        // TODO: update the code to test TradeOcoData
        expect(instance).to.be.a(GunbotRestApi.TradeOcoData);
      });
