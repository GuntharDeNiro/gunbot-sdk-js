...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlOverviewRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlOverviewRequest();
      });

      it('should create an instance of PnlOverviewRequest', function() {
        // TODO: update the code to test PnlOverviewRequest
        expect(instance).to.be.a(GunbotRestApi.PnlOverviewRequest);
      });
