...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigStrategyAddRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ConfigStrategyAddRequest();
      });

      it('should create an instance of ConfigStrategyAddRequest', function() {
        // TODO: update the code to test ConfigStrategyAddRequest
        expect(instance).to.be.a(GunbotRestApi.ConfigStrategyAddRequest);
      });
