...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeStopLimitData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeStopLimitData();
      });

      it('should create an instance of TradeStopLimitData', function() {
        // TODO: update the code to test TradeStopLimitData
        expect(instance).to.be.a(GunbotRestApi.TradeStopLimitData);
      });
