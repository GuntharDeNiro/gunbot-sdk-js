...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PairsDetailedResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PairsDetailedResponse();
      });

      it('should create an instance of PairsDetailedResponse', function() {
        // TODO: update the code to test PairsDetailedResponse
        expect(instance).to.be.a(GunbotRestApi.PairsDetailedResponse);
      });
      ...
      it('should have the property pairList (base name: "pairList")', function() {
        // TODO: update the code to test the property pairList
        expect(instance).to.have.property('pairList');
        // expect(instance.pairList).to.be(expectedValueLiteral);
      });
