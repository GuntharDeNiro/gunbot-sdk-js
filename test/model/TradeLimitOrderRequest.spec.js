...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeLimitOrderRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeLimitOrderRequest();
      });

      it('should create an instance of TradeLimitOrderRequest', function() {
        // TODO: update the code to test TradeLimitOrderRequest
        expect(instance).to.be.a(GunbotRestApi.TradeLimitOrderRequest);
      });
