...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCloseMarketRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCloseMarketRequest();
      });

      it('should create an instance of TradeCloseMarketRequest', function() {
        // TODO: update the code to test TradeCloseMarketRequest
        expect(instance).to.be.a(GunbotRestApi.TradeCloseMarketRequest);
      });
