...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ChartDataRequest();
      });

      it('should create an instance of ChartDataRequest', function() {
        // TODO: update the code to test ChartDataRequest
        expect(instance).to.be.a(GunbotRestApi.ChartDataRequest);
      });
