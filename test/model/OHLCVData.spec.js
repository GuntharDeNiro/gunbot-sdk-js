...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OHLCVData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OHLCVData();
      });

      it('should create an instance of OHLCVData', function() {
        // TODO: update the code to test OHLCVData
        expect(instance).to.be.a(GunbotRestApi.OHLCVData);
      });
