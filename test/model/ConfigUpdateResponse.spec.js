...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigUpdateResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ConfigUpdateResponse();
      });

      it('should create an instance of ConfigUpdateResponse', function() {
        // TODO: update the code to test ConfigUpdateResponse
        expect(instance).to.be.a(GunbotRestApi.ConfigUpdateResponse);
      });
