...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OneOfOrderItemId', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OneOfOrderItemId();
      });

      it('should create an instance of OneOfOrderItemId', function() {
        // TODO: update the code to test OneOfOrderItemId
        expect(instance).to.be.a(GunbotRestApi.OneOfOrderItemId);
      });
