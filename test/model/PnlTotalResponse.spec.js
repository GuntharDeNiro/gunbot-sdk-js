...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlTotalResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlTotalResponse();
      });

      it('should create an instance of PnlTotalResponse', function() {
        // TODO: update the code to test PnlTotalResponse
        expect(instance).to.be.a(GunbotRestApi.PnlTotalResponse);
      });
