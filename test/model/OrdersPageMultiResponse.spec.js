...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdersPageMultiResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OrdersPageMultiResponse();
      });

      it('should create an instance of OrdersPageMultiResponse', function() {
        // TODO: update the code to test OrdersPageMultiResponse
        expect(instance).to.be.a(GunbotRestApi.OrdersPageMultiResponse);
      });
