...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigFullResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ConfigFullResponse();
      });

      it('should create an instance of ConfigFullResponse', function() {
        // TODO: update the code to test ConfigFullResponse
        expect(instance).to.be.a(GunbotRestApi.ConfigFullResponse);
      });
