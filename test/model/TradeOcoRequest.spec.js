...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeOcoRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeOcoRequest();
      });

      it('should create an instance of TradeOcoRequest', function() {
        // TODO: update the code to test TradeOcoRequest
        expect(instance).to.be.a(GunbotRestApi.TradeOcoRequest);
      });
