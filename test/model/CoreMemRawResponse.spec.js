...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoreMemRawResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.CoreMemRawResponse();
      });

      it('should create an instance of CoreMemRawResponse', function() {
        // TODO: update the code to test CoreMemRawResponse
        expect(instance).to.be.a(GunbotRestApi.CoreMemRawResponse);
      });
