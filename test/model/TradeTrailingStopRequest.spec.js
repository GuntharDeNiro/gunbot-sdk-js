...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeTrailingStopRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeTrailingStopRequest();
      });

      it('should create an instance of TradeTrailingStopRequest', function() {
        // TODO: update the code to test TradeTrailingStopRequest
        expect(instance).to.be.a(GunbotRestApi.TradeTrailingStopRequest);
      });
