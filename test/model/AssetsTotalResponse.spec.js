...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AssetsTotalResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.AssetsTotalResponse();
      });

      it('should create an instance of AssetsTotalResponse', function() {
        // TODO: update the code to test AssetsTotalResponse
        expect(instance).to.be.a(GunbotRestApi.AssetsTotalResponse);
      });
