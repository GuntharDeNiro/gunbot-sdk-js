...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketOrderbookResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.MarketOrderbookResponse();
      });

      it('should create an instance of MarketOrderbookResponse', function() {
        // TODO: update the code to test MarketOrderbookResponse
        expect(instance).to.be.a(GunbotRestApi.MarketOrderbookResponse);
      });
