...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdersDayResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OrdersDayResponse();
      });

      it('should create an instance of OrdersDayResponse', function() {
        // TODO: update the code to test OrdersDayResponse
        expect(instance).to.be.a(GunbotRestApi.OrdersDayResponse);
      });
      ...
      it('should have the property closeOrders (base name: "closeOrders")', function() {
        // TODO: update the code to test the property closeOrders
        expect(instance).to.have.property('closeOrders');
        // expect(instance.closeOrders).to.be(expectedValueLiteral);
      });
