...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeTrailingStopData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeTrailingStopData();
      });

      it('should create an instance of TradeTrailingStopData', function() {
        // TODO: update the code to test TradeTrailingStopData
        expect(instance).to.be.a(GunbotRestApi.TradeTrailingStopData);
      });

      it('should have the property exch (base name: "exch")', function() {
        // TODO: update the code to test the property exch
        expect(instance).to.have.property('exch');
        // expect(instance.exch).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property amt (base name: "amt")', function() {
        // TODO: update the code to test the property amt
        expect(instance).to.have.property('amt');
        // expect(instance.amt).to.be(expectedValueLiteral);
      });
