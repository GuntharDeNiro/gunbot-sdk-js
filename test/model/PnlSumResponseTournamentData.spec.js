...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlSumResponseTournamentData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlSumResponseTournamentData();
      });

      it('should create an instance of PnlSumResponseTournamentData', function() {
        // TODO: update the code to test PnlSumResponseTournamentData
        expect(instance).to.be.a(GunbotRestApi.PnlSumResponseTournamentData);
      });

      it('should have the property sommaPnl (base name: "sommaPnl")', function() {
        // TODO: update the code to test the property sommaPnl
        expect(instance).to.have.property('sommaPnl');
        // expect(instance.sommaPnl).to.be(expectedValueLiteral);
      });

      it('should have the property invested (base name: "invested")', function() {
        // TODO: update the code to test the property invested
        expect(instance).to.have.property('invested');
        // expect(instance.invested).to.be(expectedValueLiteral);
      });
