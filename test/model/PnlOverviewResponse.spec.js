...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlOverviewResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlOverviewResponse();
      });

      it('should create an instance of PnlOverviewResponse', function() {
        // TODO: update the code to test PnlOverviewResponse
        expect(instance).to.be.a(GunbotRestApi.PnlOverviewResponse);
      });
