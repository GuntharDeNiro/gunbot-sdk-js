...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCloseLimitData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCloseLimitData();
      });

      it('should create an instance of TradeCloseLimitData', function() {
        // TODO: update the code to test TradeCloseLimitData
        expect(instance).to.be.a(GunbotRestApi.TradeCloseLimitData);
      });
