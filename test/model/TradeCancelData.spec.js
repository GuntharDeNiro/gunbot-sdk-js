...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCancelData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCancelData();
      });

      it('should create an instance of TradeCancelData', function() {
        // TODO: update the code to test TradeCancelData
        expect(instance).to.be.a(GunbotRestApi.TradeCancelData);
      });
