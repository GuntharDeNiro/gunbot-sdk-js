...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketCandlesResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.MarketCandlesResponse();
      });

      it('should create an instance of MarketCandlesResponse', function() {
        // TODO: update the code to test MarketCandlesResponse
        expect(instance).to.be.a(GunbotRestApi.MarketCandlesResponse);
      });
