...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeStopLimitRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeStopLimitRequest();
      });

      it('should create an instance of TradeStopLimitRequest', function() {
        // TODO: update the code to test TradeStopLimitRequest
        expect(instance).to.be.a(GunbotRestApi.TradeStopLimitRequest);
      });
