...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileWriteRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.FileWriteRequest();
      });

      it('should create an instance of FileWriteRequest', function() {
        // TODO: update the code to test FileWriteRequest
        expect(instance).to.be.a(GunbotRestApi.FileWriteRequest);
      });
