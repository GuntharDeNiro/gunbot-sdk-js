...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlDailyPaginatedResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlDailyPaginatedResponse();
      });

      it('should create an instance of PnlDailyPaginatedResponse', function() {
        // TODO: update the code to test PnlDailyPaginatedResponse
        expect(instance).to.be.a(GunbotRestApi.PnlDailyPaginatedResponse);
      });
