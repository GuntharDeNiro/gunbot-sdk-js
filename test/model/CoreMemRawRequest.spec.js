...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoreMemRawRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.CoreMemRawRequest();
      });

      it('should create an instance of CoreMemRawRequest', function() {
        // TODO: update the code to test CoreMemRawRequest
        expect(instance).to.be.a(GunbotRestApi.CoreMemRawRequest);
      });
