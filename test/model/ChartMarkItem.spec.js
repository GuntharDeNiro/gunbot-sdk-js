...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartMarkItem', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ChartMarkItem();
      });

      it('should create an instance of ChartMarkItem', function() {
        // TODO: update the code to test ChartMarkItem
        expect(instance).to.be.a(GunbotRestApi.ChartMarkItem);
      });
