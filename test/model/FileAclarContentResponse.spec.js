...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileAclarContentResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.FileAclarContentResponse();
      });

      it('should create an instance of FileAclarContentResponse', function() {
        // TODO: update the code to test FileAclarContentResponse
        expect(instance).to.be.a(GunbotRestApi.FileAclarContentResponse);
      });

      it('should have the property _this (base name: "this")', function() {
        // TODO: update the code to test the property _this
        expect(instance).to.have.property('_this');
        // expect(instance._this).to.be(expectedValueLiteral);
      });
