...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCloseLimitRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCloseLimitRequest();
      });

      it('should create an instance of TradeCloseLimitRequest', function() {
        // TODO: update the code to test TradeCloseLimitRequest
        expect(instance).to.be.a(GunbotRestApi.TradeCloseLimitRequest);
      });
