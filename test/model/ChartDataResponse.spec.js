...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ChartDataResponse();
      });

      it('should create an instance of ChartDataResponse', function() {
        // TODO: update the code to test ChartDataResponse
        expect(instance).to.be.a(GunbotRestApi.ChartDataResponse);
      });
