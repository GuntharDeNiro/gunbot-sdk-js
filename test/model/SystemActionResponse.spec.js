...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SystemActionResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.SystemActionResponse();
      });

      it('should create an instance of SystemActionResponse', function() {
        // TODO: update the code to test SystemActionResponse
        expect(instance).to.be.a(GunbotRestApi.SystemActionResponse);
      });
