...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PnlDailyResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PnlDailyResponse();
      });

      it('should create an instance of PnlDailyResponse', function() {
        // TODO: update the code to test PnlDailyResponse
        expect(instance).to.be.a(GunbotRestApi.PnlDailyResponse);
      });

      it('should have the property dateRangeDailyHistory (base name: "dateRangeDailyHistory")', function() {
        // TODO: update the code to test the property dateRangeDailyHistory
        expect(instance).to.have.property('dateRangeDailyHistory');
        // expect(instance.dateRangeDailyHistory).to.be(expectedValueLiteral);
      });

      it('should have the property unmatchedBaseValuePerDateRange (base name: "unmatchedBaseValuePerDateRange")', function() {
        // TODO: update the code to test the property unmatchedBaseValuePerDateRange
        expect(instance).to.have.property('unmatchedBaseValuePerDateRange');
        // expect(instance.unmatchedBaseValuePerDateRange).to.be(expectedValueLiteral);
      });
