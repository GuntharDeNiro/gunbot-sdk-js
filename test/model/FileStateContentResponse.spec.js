...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileStateContentResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.FileStateContentResponse();
      });

      it('should create an instance of FileStateContentResponse', function() {
        // TODO: update the code to test FileStateContentResponse
        expect(instance).to.be.a(GunbotRestApi.FileStateContentResponse);
      });
