...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PairsResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.PairsResponse();
      });

      it('should create an instance of PairsResponse', function() {
        // TODO: update the code to test PairsResponse
        expect(instance).to.be.a(GunbotRestApi.PairsResponse);
      });
