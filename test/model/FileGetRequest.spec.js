...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileGetRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.FileGetRequest();
      });

      it('should create an instance of FileGetRequest', function() {
        // TODO: update the code to test FileGetRequest
        expect(instance).to.be.a(GunbotRestApi.FileGetRequest);
      });
