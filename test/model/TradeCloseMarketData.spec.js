...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCloseMarketData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCloseMarketData();
      });

      it('should create an instance of TradeCloseMarketData', function() {
        // TODO: update the code to test TradeCloseMarketData
        expect(instance).to.be.a(GunbotRestApi.TradeCloseMarketData);
      });
