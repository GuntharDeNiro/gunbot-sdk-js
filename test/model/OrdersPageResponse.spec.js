...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdersPageResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.OrdersPageResponse();
      });

      it('should create an instance of OrdersPageResponse', function() {
        // TODO: update the code to test OrdersPageResponse
        expect(instance).to.be.a(GunbotRestApi.OrdersPageResponse);
      });
