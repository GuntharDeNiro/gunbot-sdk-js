...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeCancelRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.TradeCancelRequest();
      });

      it('should create an instance of TradeCancelRequest', function() {
        // TODO: update the code to test TradeCancelRequest
        expect(instance).to.be.a(GunbotRestApi.TradeCancelRequest);
      });
