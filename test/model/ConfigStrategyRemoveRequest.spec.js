...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigStrategyRemoveRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.ConfigStrategyRemoveRequest();
      });

      it('should create an instance of ConfigStrategyRemoveRequest', function() {
        // TODO: update the code to test ConfigStrategyRemoveRequest
        expect(instance).to.be.a(GunbotRestApi.ConfigStrategyRemoveRequest);
      });
