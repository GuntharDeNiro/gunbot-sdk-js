...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoreMemSnapshotResponse', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.CoreMemSnapshotResponse();
      });

      it('should create an instance of CoreMemSnapshotResponse', function() {
        // TODO: update the code to test CoreMemSnapshotResponse
        expect(instance).to.be.a(GunbotRestApi.CoreMemSnapshotResponse);
      });
