...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileStrategyWriteRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.FileStrategyWriteRequest();
      });

      it('should create an instance of FileStrategyWriteRequest', function() {
        // TODO: update the code to test FileStrategyWriteRequest
        expect(instance).to.be.a(GunbotRestApi.FileStrategyWriteRequest);
      });
