...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AssetsTotalRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.AssetsTotalRequest();
      });

      it('should create an instance of AssetsTotalRequest', function() {
        // TODO: update the code to test AssetsTotalRequest
        expect(instance).to.be.a(GunbotRestApi.AssetsTotalRequest);
      });
