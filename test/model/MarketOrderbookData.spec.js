...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketOrderbookData', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.MarketOrderbookData();
      });

      it('should create an instance of MarketOrderbookData', function() {
        // TODO: update the code to test MarketOrderbookData
        expect(instance).to.be.a(GunbotRestApi.MarketOrderbookData);
      });
