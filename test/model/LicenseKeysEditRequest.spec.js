...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LicenseKeysEditRequest', function() {
      beforeEach(function() {
        instance = new GunbotRestApi.LicenseKeysEditRequest();
      });

      it('should create an instance of LicenseKeysEditRequest', function() {
        // TODO: update the code to test LicenseKeysEditRequest
        expect(instance).to.be.a(GunbotRestApi.LicenseKeysEditRequest);
      });
      ...
      it('should have the property newLicenses (base name: "newLicenses")', function() {
        // TODO: update the code to test the property newLicenses
        expect(instance).to.have.property('newLicenses');
        // expect(instance.newLicenses).to.be(expectedValueLiteral);
      });

      it('should have the property verifyExchange (base name: "verifyExchange")', function() {
        // TODO: update the code to test the property verifyExchange
        expect(instance).to.have.property('verifyExchange');
        // expect(instance.verifyExchange).to.be(expectedValueLiteral);
      });
